...
public class BluetoothMatchActivity extends AppCompatActivity {
    ...
    private void updateDeviceList() {
        ...
        int hasPermission = ActivityCompat.checkSelfPermission(BluetoothMatchActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
        if (hasPermission != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(BluetoothMatchActivity.this,
                    new String[]{
